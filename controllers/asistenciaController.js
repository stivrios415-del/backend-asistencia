...
// Exportar reporte completo (todos los estudiantes, Presente/Ausente) para una fecha
const exportarReporteCompletoExcel = async (req, res) => {
  ...
  console.log(`📊 Exportando reporte completo - Fecha: ${fecha}, Usuario: ${usuario || 'anon'}`);

  try {
    // Obtener todos los estudiantes (incluye carrera y foto_url si quieres, pero para el Excel no son necesarios)
