...
router.get('/grados-secciones', estudianteController.getGradosSecciones); // ✅ Ruta específica PRIMERO
router.get('/:cedula', estudianteController.getEstudianteByCedula);      // ⬅️ Genérica después
